                        ...
                        <form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto">
                            ...
                            <!-- <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                                ...
                                <select id="tabulator-html-filter-value" type="text" class="form-control sm:w-40 2xl:w-full mt-2 sm:mt-0" placeholder="Search...">
                                    ...
                                    <option class="dropdown-item">Supplier </option>
                                    <option class="dropdown-item">Agarwal Safety CLothes</option>
                                    <option class="dropdown-item">HP Store</option>
                                    <option class="dropdown-item">MTN </option>
                                    <option class="dropdown-item">GA Department</option>
                                    <option class="dropdown-item">Lost</option>
                                            <option class="dropdown-item">Out of repair</option>
