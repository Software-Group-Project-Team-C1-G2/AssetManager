                    ...
                    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                        <form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto">
                            ...
                            <!-- <div class="sm:flex items-center sm:mr-4 mt-2 xl:mt-0">
                                <label class="w-12 flex-none xl:w-auto xl:flex-initial mr-2">Asset Type</label>
                                <select id="tabulator-html-filter-value" type="text" class="form-control sm:w-40 2xl:w-full mt-2 sm:mt-0" placeholder="Search...">


                                    <option class="dropdown-item">Asset Type </option>
                                    <option class="dropdown-item">Desktop</option>
                                    <option class="dropdown-item">Notebook</option>
                                    <option class="dropdown-item">Impressora </option>
                                    <option class="dropdown-item">Monitor</option>
                                    <option class="dropdown-item">Lost</option>
                                    <option class="dropdown-item">PPE</option>
