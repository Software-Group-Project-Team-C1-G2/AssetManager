...
<body class="py-5">
        ...
        <div class="content">
            ...
            <body class="py-5">
                ...
                <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    ...
                    <!-- BEGIN: Modal Toggle -->
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#header-footer-modal-preview" class="btn btn-primary">Add Department Data</a>
                    <!-- END: Modal Toggle -->
                    <!-- BEGIN: Modal Content -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header success">
                                    <div class="alert alert-success-soft show flex items-center mb-2" style="width:100%" role="alert"> <i data-lucide="thumbs-up" class="w-6 h-6 mr-2"></i> Department Data Added Successfully ! </div>
                                ...
                                <div class="modal-header">
                                    <h2 class="font-medium text-base mr-auto" id="add_data">Add Department Data</h2>
                                ...
                                <!-- BEGIN: Modal Body -->
                                <form id="at-form" action="action.php" method="post">
                                    ...
                                    <input type="hidden" id="tbl" name="tbl" value="tbl_loc_brands_dep_atype">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-bordered table-striped" id="example">
                                                ...
                                                <tbody class="studentdata" id="dep">
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function($) {
            loadData();
            var DOMAIN = "http://localhost/Rubick/Inventory%20Management%20Website/";
