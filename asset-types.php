        ...
        <div class="content">
            ...
            <body class="py-5">
                ...
                <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    ...
                    <!-- Delete Modal End -->
                    <!-- BEGIN: Modal Toggle -->
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#header-footer-modal-preview" class="btn btn-primary">Add Asset Type Data</a>
                    <!-- END: Modal Toggle -->
                    <!-- BEGIN: Modal Content -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header success">
                                    <div class="alert alert-success-soft show flex items-center mb-2" style="width:100%" role="alert"> <i data-lucide="thumbs-up" class="w-6 h-6 mr-2"></i> Asset Type Data Added Successfully ! </div>
                                ...
                                <div class="modal-header">
                                    <h2 class="font-medium text-base mr-auto" id="add_data">Add Asset Type Data</h2>
                                ...
                                <form id="at-form" method="post">
                                    ...
                                    <input type="hidden" name="atype_id" id="atype_id" />
                                    <!-- BEGIN: Modal Footer -->
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-bordered table-striped" id="example">
                                                ...
                                                <tbody class="atypedata" id="brands">
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function($) {
            ...
            $(document).on('click', '.edit_data', function() {
                var atype_id = $(this).attr("id");
                // console.log(dep_id);
                atype_id = atype_id.split(" ");
